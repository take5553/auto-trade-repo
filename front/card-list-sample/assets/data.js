/* ── Sample data ── */
function genSparkline(basePrice, points, volatility) {
  const data = [];
  let v = basePrice;
  for (let i = 0; i < points; i++) {
    v += (Math.random() - 0.48) * volatility;
    v = Math.max(basePrice * 0.85, v);
...
const POSITIONS = [
  {
    ...
    pct: '+1.37',
    duration: '2h 14m',
    spark: genSparkline(42100, 30, 400),
  },
  {
    id: 2,
    symbol: 'ETH/USDT',
  ...
  },
  {
    ...
    pct: '+1.82',
    duration: '0h 41m',
    spark: genSparkline(0.592, 30, 0.005),
  },
  {
    id: 6,
    symbol: 'MATIC/USDT',
    ...
    pct: '+3.52',
    duration: '3h 20m',
    spark: genSparkline(0.881, 30, 0.008),
  },
  {
    id: 7,
    symbol: 'DOGE/USDT',
    ...
    pct: '-4.11',
    duration: '5h 05m',
    spark: genSparkline(0.1045, 30, 0.001),
  },
];
