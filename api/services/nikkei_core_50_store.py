...
TICKER_INFO: dict[str, dict[str, str]] = {
    "2502.T": {"name": "アサヒグループHD",         "sector": "食品・日用品"},
    "2802.T": {"name": "味の素",                   "sector": "食品・日用品"},
    "2914.T": {"name": "日本たばこ産業",             "sector": "食品・日用品"},
    "4452.T": {"name": "花王",                     "sector": "食品・日用品"},
    "3402.T": {"name": "東レ",                     "sector": "素材・化学"},
    "4063.T": {"name": "信越化学工業",               "sector": "素材・化学"},
    "4188.T": {"name": "三菱ケミカルグループ",         "sector": "素材・化学"},
    "5401.T": {"name": "日本製鉄",                  "sector": "素材・化学"},
    "5713.T": {"name": "住友金属鉱山",               "sector": "素材・化学"},
    "4502.T": {"name": "武田薬品工業",               "sector": "医薬品・医療"},
    "4503.T": {"name": "アステラス製薬",              "sector": "医薬品・医療"},
    "4519.T": {"name": "中外製薬",                  "sector": "医薬品・医療"},
    "4568.T": {"name": "第一三共",                  "sector": "医薬品・医療"},
    "7733.T": {"name": "オリンパス",                 "sector": "医薬品・医療"},
    "6301.T": {"name": "コマツ",                   "sector": "機械・資本財"},
    "6367.T": {"name": "ダイキン工業",               "sector": "機械・資本財"},
    "6506.T": {"name": "安川電機",                  "sector": "機械・資本財"},
    "7011.T": {"name": "三菱重工業",                "sector": "機械・資本財"},
    ...
    "7201.T": {"name": "日産自動車",                "sector": "自動車"},
    "7203.T": {"name": "トヨタ自動車",               "sector": "自動車"},
    "7267.T": {"name": "本田技研工業",               "sector": "自動車"},
    "7269.T": {"name": "スズキ",                   "sector": "自動車"},
    "8001.T": {"name": "伊藤忠商事",                "sector": "商社"},
    "8031.T": {"name": "三井物産",                  "sector": "商社"},
    "8053.T": {"name": "住友商事",                  "sector": "商社"},
    "8058.T": {"name": "三菱商事",                  "sector": "商社"},
    "3382.T": {"name": "セブン&アイHD",             "sector": "小売・サービス"},
    "4324.T": {"name": "電通グループ",               "sector": "小売・サービス"},
    "4689.T": {"name": "LINEヤフー",               "sector": "小売・サービス"},
    "4755.T": {"name": "楽天グループ",               "sector": "小売・サービス"},
    "9983.T": {"name": "ファーストリテイリング",        "sector": "小売・サービス"},
    "8306.T": {"name": "三菱UFJフィナンシャルG",      "sector": "金融"},
    "8316.T": {"name": "三井住友フィナンシャルG",       "sector": "金融"},
    "8411.T": {"name": "みずほフィナンシャルG",        "sector": "金融"},
    "8604.T": {"name": "野村HD",                   "sector": "金融"},
    "8766.T": {"name": "東京海上HD",                "sector": "金融"},
    "8801.T": {"name": "三井不動産",                "sector": "不動産・インフラ"},
    "8802.T": {"name": "三菱地所",                  "sector": "不動産・インフラ"},
    "9531.T": {"name": "東京ガス",                  "sector": "不動産・インフラ"},
    ...
    "9432.T": {"name": "日本電信電話",               "sector": "情報・通信"},
    "9433.T": {"name": "KDDI",                    "sector": "情報・通信"},
    "9434.T": {"name": "ソフトバンク",               "sector": "情報・通信"},
