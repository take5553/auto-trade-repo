...
const LAST_EQUITY   = EQUITY[EQUITY.length - 1].value;
const FIRST_EQUITY  = EQUITY[0].value;
const EQUITY_CHANGE = ((LAST_EQUITY - FIRST_EQUITY) / FIRST_EQUITY * 100).toFixed(2);
