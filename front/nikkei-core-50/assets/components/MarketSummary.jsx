  ...
  return (
    <div className="market-summary">
      <div className="summary-item">
        <span className="summary-label">銘柄数</span>
        <span className="summary-value" style={{ color: '#58a6ff' }}>{summary.total_stocks}</span>
      </div>
      ...
      <div className="summary-item">
        ...
        <span style={{ fontSize: 13, fontVariantNumeric: 'tabular-nums', color: '#8b949e' }}>{summary.as_of}</span>
      </div>
    </div>
  );
};
